...
这是 **cc-skills-dev** 工作空间中的示例项目，展示了如何使用Claude Code Agent Skills来解决实际的业务问题。

**本项目的目标**：帮助软件测试工程师将海运系统需求文档自动转换为测试用例。
...
│   └── #77879 海运系统添加直达中转字段-cleaned.json
└── testcases/                            # 生成的测试用例（Excel格式）
    └── #77879 海运系统添加直达中转字段-测试用例.xlsx
```
